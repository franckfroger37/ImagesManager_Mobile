...
const STATUS_LABEL = {
  publish: { label: 'PubliÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©',    bg: '#dcfce7', text: '#15803d', icon: 'eye-outline' },
    ...
    return (
      <TouchableOpacity style={styles.row} onPress={onPress}>
        ...
        <View style={styles.rowInfo}>
          ...
          <Text style={styles.rowPrice}>{parseFloat(product.price).toFixed(2)} ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¬</Text>
        </View>
...
// ─── ErrorBoundary pour afficher les erreurs au lieu de page blanche ───
...
export default function ManageProductsScreen({ navigation }) {
  ...
  // Produit sÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©lectionnÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© pour le panneau d'actions
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      getSettings().then((s) => {
        ...
        setSettings(prev => {
          if (!prev) return s;
          try { if (JSON.stringify(prev) === JSON.stringify(s)) return prev; } catch {}
          return s;
        });
  ...
  // Met ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ  jour localement la liste aprÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¨s une action
  ...
  const handleCorrectPrice = async () => {
    ...
    if (!p || p <= 0) { setActionMsg({ ok: false, msg: 'ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¸ÃÂÃÂÃÂÃÂ Prix invalide.' }); return; }
    setActioning(true);
    try {
      await updateProductPrice(selected.id, p, settings);
      updateLocalProduct(selected.id, { price: p.toFixed(2) });
      setActionMsg({ ok: true, msg: `ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Prix mis ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ  jour : ${p.toFixed(2)} ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¬` });
    } catch (e) {
      setActionMsg({ ok: false, msg: `ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ${e.message}` });
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setSearchResults([]);
      setActionMsg({ ok: false, msg: 'ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Erreur recherche: ' + e.message });
    } finally {
      setSearching(false);
    }
  };
  ...
  // ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Rendu d'un produit dans la liste ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ

  return (
    <ErrorBoundary>
    <SafeAreaView style={styles.container}>

      {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ En-tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂªte avec bouton refresh ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
      ...
      {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂtats ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
      {error && (
      ...
      {!loading && !error && products.length === 0 && (
        <View style={styles.emptyBox}>
          ...
          <Text style={styles.emptyText}>Aucun produit trouvÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©</Text>
        </View>
      )}

      {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Liste ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
      {/* Barre de recherche */}
        ...
        <View style={styles.searchResultsBox}>
          <View style={styles.searchResultsHeader}>
            <Text style={styles.searchResultsTitle}>
              {searchResults.length === 0 ? 'Aucun rÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©sultat' : searchResults.length + ' rÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©sultat(s)'}
            </Text>
          ...
          {searchResults.map(product => (
            <TouchableOpacity key={product.id} style={styles.productRow} onPress={() => openPanel(product)}>
              <View style={styles.productInfo}>
                ...
                <Text style={styles.productMeta}>{'#' + product.id + ' - ' + product.price + 'ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¬'}</Text>
              </View>
      ...
      {loading && products.length === 0 ? (
        ...
        <View style={styles.loadingCenter}>
          <Text style={styles.loadingCenterText}>{error ? error : 'Aucun produit trouvÃ©'}</Text>
          <TouchableOpacity
            style={styles.retryBtn}
            onPress={() => getSettings().then(s => loadProducts(s))}
          >
      ...
      {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Panneau d'actions (modal) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
      <Modal visible={showPanel && !!selected} transparent animationType="none" onRequestClose={closePanel}>
        <View style={styles.modalOverlay}>
          <View style={styles.panel}>

            {/* En-tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂªte du panneau */}
            ...
            {/* Message rÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©sultat */}
            {actionMsg && (
            ...
            {/* Corriger le prix */}
            <Text style={styles.actionLabel}>ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¸ÃÂÃÂÃÂÃÂ Corriger le prix</Text>
            <View style={styles.priceRow}>
              ...
              />
              <Text style={styles.euroSign}>ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¬</Text>
              <TouchableOpacity
              ...
              >
                {actioning
                  ? <ActivityIndicator size="small" color="#fff" />
                  : <Text style={styles.actionBtnText}>Mettre ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ  jour</Text>}
              </TouchableOpacity>
            </View>
          ...
          <TouchableOpacity
            ...
            {actioning ? <ActivityIndicator size="small" color="#fff" />
              : <Text style={styles.actionBtnText}>{selected.status === 'publish' ? 'DÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©publier' : 'Republier'}</Text>}
          </TouchableOpacity>
        )}
        ...
        >
          {actioning
            ...
            : <Text style={styles.actionBtnText}>Rupture de stock</Text>
              ...
              {actioning ? <ActivityIndicator size="small" color="#fff" />
                : <Text style={styles.actionBtnText}>Supprimer dÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©finitivement</Text>}
            </TouchableOpacity>
